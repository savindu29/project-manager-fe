...
const DropDown: FC<DropdownProps & { defaultSelectedId?: number }> = ({ data, dropdownFor, onSelect, defaultSelectedId, disabled }) => {
  ...
  if (disabled) {
    return (
        <div className="relative mt-2">
          <div className="w-full cursor-not-allowed rounded-md bg-gray-200 py-1.5 pl-3 pr-10 text-left text-gray-500 sm:text-sm sm:leading-6">
