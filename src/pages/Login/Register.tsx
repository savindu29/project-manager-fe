                    ...
                    <div className="mt-1 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-8">
                            <div className="mx-auto max-w-xs">
                                ...
                                <button
                                    className="mx-auto mt-6 text-sm font-medium text-gray-600 hover:bg-gray-200 hover:text-gray-900 focus:outline-none"
                                    onClick={() => {
                                        // Handle the click event for the small button (redirect to sign-up page)
                                        window.location.href = "/login";
                                    }}
                                >
                                    Already have an account? <span className="underline text-sky-600">Login</span>
                                </button>
