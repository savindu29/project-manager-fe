 ...
 useEffect(() => {
    const fetchProject = async () => {
      try {
        ...
        // Set the initial state of editedProjectDetails to the fetched project data
          ...
          <>
            <div className="w-full">
              ...
              <p className="text-sm mt-2">
                {projectDetails?.grantClient?.name} -{" "}
                <span>
                  {projectDetails?.grantClient?.country}
                </span>
              </p>
            </div>
            <div className="w-full flex justify-end items-end">
            ...
            <TextField
              name="priority"
              label="Priority"
              value={editedProjectDetails.priority}
              onChange={handleChange}
              InputLabelProps={{
                style: { fontSize: '20px' },
              }}
