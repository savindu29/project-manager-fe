...
import { ResourcesManagePage } from "./resource-employees-page";
import { useEffect, useState } from "react";
import { getProject } from "../../apis/project-api";

const ManageResourceEmployees = () => {
  const { id } = useParams();
    ...
    <div>
      <div className='flex '>
        ...
        <div className='py-2 w-full'>
          ...
          <ResourcesManagePage projectDetails={projectDetails} />
        </div>
      </div>
    </div>
  );
...
export default ManageResourceEmployees;
